 ...
 * @package Sabino
 */
define( 'SABINO_THEME_VERSION' , '1.1.21' );
		...
		<div class="notice notice-info sabino-admin-notice sabino-notice-add">
			<h4>
				...
				<span>
					...
					printf( esc_html__( 'Premium is currently on a %1$s for only $18', 'sabino' ), wp_kses( __( '<a href="https://kairaweb.com/wordpress-theme/sabino/#purchase-premium" target="_blank">35% flash sale</a>', 'sabino' ), array( 'a' => array( 'href' => array(), 'target' => array() ) ) ) );
					?>
				</span>
			</h4>
