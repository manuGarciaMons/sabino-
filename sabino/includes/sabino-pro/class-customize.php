...
final class Sabino_Premium_Customize {
		...
		$manager->add_section(
			new Sabino_Premium_Customize_Section(
				...
				array(
					...
					'pro_url'  => 'https://kairaweb.com/wordpress-theme/sabino/#purchase-premium'
				)
			)
		);
	}
	...
	public function enqueue_control_scripts() {
		wp_enqueue_script( 'sabino-customize-controls', trailingslashit( get_template_directory_uri() ) . 'includes/sabino-pro/customize-controls.js', array( 'jquery', 'customize-controls' ) );
